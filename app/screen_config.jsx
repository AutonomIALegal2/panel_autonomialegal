...
function csvRowToLead(o, i) {
  ...
  return {
    ...
    origen: /^(linkedin|web|cercano)$/i.test(o.origen || '') ? o.origen.toLowerCase() : 'linkedin',
    origenDetalle: o.origen_detalle || null,
    ultimoContacto: o.ultimo_contacto || PDATA.TODAY, teInvito: /^(si|sí|true|1|x)$/i.test(o.te_invito || ''),
    conectoEl: o.conecto_el || PDATA.TODAY, url: o.url || '', mensaje: o.mensaje || (PDATA.M1_TPL && PDATA.M1_TPL[variante] ? PDATA.M1_TPL[variante]((o.nombre || '').split(' ')[0], o.area || '', o.ciudad || '') : ''),
